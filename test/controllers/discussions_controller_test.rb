...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { description: @discussion.description, subject_id: @discussion.subject_id, title: @discussion.title, user_id: @discussion.user_id } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { description: @discussion.description, subject_id: @discussion.subject_id, title: @discussion.title, user_id: @discussion.user_id } }

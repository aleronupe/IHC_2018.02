...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post commentaries_url, params: { commentary: { discussion_id: @commentary.discussion_id, txt: @commentary.txt, user_id: @commentary.user_id } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { discussion_id: @commentary.discussion_id, txt: @commentary.txt, user_id: @commentary.user_id } }
